  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto flex  lg:items-start md:flex-row justify-center  flex-wrap flex-col">
      ...
      <div className='flex justify-center'>
          <img  className="h-60 text-white  hover:scale-125 transition-transform transform " src='https://e-cellmnnit.netlify.app/static/media/logo1.aa59d10dce000c1b6a45.png'/>
